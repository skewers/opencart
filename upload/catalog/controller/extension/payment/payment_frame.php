<?php
class ControllerExtensionPaymentPaymentFrame extends Controller {
	public function index() {
        ...
        if (strcmp($_SERVER['REQUEST_METHOD'], 'GET') == 0) {
            ...
            $this->response->setOutput($this->load->view('extension/payment/payment_frame', $data));
        } else {
            $this->response->setOutput($this->load->view('extension/payment/payment_frame_callback'));
        }
	}
